...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('laporanPdf.post') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row mt-3">
                        ...
                        <div class="col-md-9">
                            <input type="file" id="pdf" name="pdf" class="form-control" placeholder="Jumlah" required>
                        </div>
                    </div>
