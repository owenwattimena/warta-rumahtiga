    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Ibadah Harian</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-sm">
                    <thead>
                        <tr>
                            ...
                            <th>File Liturgi</th>
                            <th>
                                <a href="{{ route('ibadah.harian.tambah') }}" class="btn btn-primary btn-sm rounded-0"><i
                                        class="fa fa-plus"></i> |
                                    TAMBAH</a>
                            </th>
                        </tr>
                    ...
                    <tbody>
                        @foreach ($ibadah as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ asset('storage/ibadah/harian') }}/{{ $item->file_liturgi }}"
                                        target="_blank">
                                        {{ $item->file_liturgi }}
                                    </a>
                                </td>
                                <td>
                                    <a href="{{ route('ibadah.harian.ubah', $item->id) }}"
                                        class="btn btn-warning rounded-0 btn-sm">
                                        <i class="fa fa-edit"></i> | UBAH
                                    </a>
                                    <form action="{{ route('ibadah.harian.hapus', $item->id) }}" method="POST"
